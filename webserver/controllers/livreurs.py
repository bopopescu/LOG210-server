...
def index(id):
    ...
    # Check livreur
    if livreur is None:
        return make_response("Le livreur n'existe pas.", 400)
...
def create():
    ...
    try:
        ...
        db.session.rollback()
        return make_response("Dûe à une erreur inconnu, le livreur ne peut pas être créé.", 500)
...
def update(id):
    ...
    if livreur is None:
        return make_response("Le livreur n'existe pas.", 404)
    ...
    try:
        ...
        db.session.rollback()
        return make_response("Dûe à une erreur inconnu, le livreur ne peut pas être modifié.", 500)
...
def delete(id):
    ...
    try:
        ...
        db.session.rollback()
        return make_response("Dûe à une erreur inconnu, le livreur ne peut pas être supprimé.", 500)
